# Generated by Django 6.0.5 on 2026-05-17 19:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('operations', '0005_alter_expense_payment_method'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='expense',
            name='expense_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='expenses', to='operations.expensetype'),
        ),
        migrations.AlterField(
            model_name='task',
            name='assigned_to',
