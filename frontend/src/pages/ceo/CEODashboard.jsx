            ...
            <div style={styles.body}>
                ...
                <div style={styles.metricsLarge}>
                    <div style={{ ...styles.metricCard, ...styles.metricAccent }}>
                        <div style={{ ...styles.metricLabel, color: '#085041' }}>This month</div>
                    ...
                    <div style={styles.metricCard}>
                        ...
                        <div style={styles.metricValue}>KES {weekTotal.toLocaleString()}</div>
                        <div style={styles.metricSub}>
                            {expenses.filter(e => new Date(e.created_at) >= weekAgo).length} expenses
                        </div>
                    </div>
                </div>
                ...
                <div style={styles.metricsSmall}>
                    ...
                    <div style={styles.metricCard}>
                        ...
                        <div style={{ ...styles.metricValue, fontSize: '16px' }}>
                            {[...new Set(expenses.map(e => e.created_by))].length}
                        </div>
                        <div style={styles.metricSub}>active</div>
                    </div>
                    <div style={styles.metricCard}>
                        <div style={styles.metricLabel}>Tasks</div>
                        <div style={{ ...styles.metricValue, fontSize: '16px' }}>{tasks.length}</div>
                        ...
                        >
                            <div>
                                ...
                                <div style={styles.rowSub}>
                                    {expense.created_by} · {expense.created_at.split('T')[0]}
                                </div>
                            </div>
                            <div style={styles.amount}>KES {parseFloat(expense.amount).toLocaleString()}</div>
                        </div>
                    ))}
                </div>
                ...
                <div style={{ ...styles.card, marginBottom: '80px' }}>
                    ...
                    {recentTasks.map((task, index) => (
                        ...
                        >
                            ...
                            <div style={task.assigned_to ? styles.assignedBadge : styles.unassignedBadge}>
...
const styles = {
    ...
    metricsLarge: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '8px' },
    metricsSmall: { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px', marginBottom: '16px' },
    ...
    assignedBadge: { fontSize: '11px', padding: '2px 8px', borderRadius: '20px', background: '#E6F1FB', color: '#0C447C', fontWeight: '500' },
    unassignedBadge: { fontSize: '11px', padding: '2px 8px', borderRadius: '20px', background: '#F1EFE8', color: '#5F5E5A', fontWeight: '500' },
